...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="card p-3 hover:shadow-lg transition flex flex-col">
      {/* 🔹 Image Section with Zoom Effect + Redirect */}
      <Link to={`/product/${product.id}`}>
        <div className="h-48 bg-white/60 rounded-xl mb-3 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="text-xs text-dim">{product.category}</div>

        <div className="mt-1 text-sm">
          <span className="font-bold">₹{discounted_price}</span>
          <span className="line-through text-dim ml-2">
